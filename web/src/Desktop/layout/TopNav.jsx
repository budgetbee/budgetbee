            ...
            <div className="flex gap-x-2 items-center basis-10/12">
                <form onSubmit={handleSearchForm}>
                    <div date-rangepicker className="flex gap-x-2 items-center">
                        ...
                        <div className="px-5">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="search"
                                    name="search_term"
                                    class="border cursor-pointer text-sm rounded-lg block w-full pl-10 p-2.5 w-80 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Search"
                                ></input>
                            </div>
                        </div>
                        <button
                            type="submit"
                            class="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800"
                        >
                            Filter
                        </button>
                    </div>
