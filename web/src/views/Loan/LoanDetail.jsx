        ...
        <div className="bg-[#0a0a0f] min-h-screen">
                    ...
                    {!showPaymentForm && Number(loan.remaining) > 0 && (
                        <div className="flex flex-row gap-2">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-xl text-sm font-medium"
                            >
            ...
            {showAttachModal && (
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60">
                    <div className="w-full bg-[#12121f] border border-gray-700 rounded-t-2xl p-4 max-h-[80vh] flex flex-col">
                        ...
                        <div className="flex items-center gap-2 bg-[#0a0a0f] border border-gray-700 rounded-xl px-3 mb-3">
                            <FontAwesomeIcon
                                icon={faSearch}
                        ...
                        {attachMsg && (
                            <div className="bg-red-800 text-red-100 p-3 rounded-xl mb-3 text-sm">
                                {attachMsg}
                            </div>
                        )}
                            ...
                            {attachLoading ? (
                                ...
                                attachResults.map((record) => (
                                    <button
                                        ...
                                        className="w-full flex flex-row items-center justify-between bg-[#0a0a0f] border border-gray-800 rounded-xl px-4 py-3 mb-2 hover:border-blue-500 text-left"
                                    >
